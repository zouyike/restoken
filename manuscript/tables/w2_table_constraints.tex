\begin{table}[htbp]
\centering
\caption{Property-constrained generation (Experiment~3, ResToken, $n=100$ requested per condition). Constraint satisfaction = fraction of valid sequences meeting all profile constraints. Random baseline acceptance rates: permeable 2.07\%, charged 1.82\%, rigid 0.81\%.}
